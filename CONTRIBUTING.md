...
Thank you for your interest in `nodewho`, an open source project
administered by StrongLoop.

Contributing to `nodewho` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/node-who)
